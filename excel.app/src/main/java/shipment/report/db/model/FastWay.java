...
public class FastWay {
	...
	private String companyNameRequired;
	...
	public String getCompanyNameRequired() {
		return companyNameRequired;
	}

	public void setCompanyNameRequired(String companyNameRequired) {
		this.companyNameRequired = companyNameRequired;
	}
