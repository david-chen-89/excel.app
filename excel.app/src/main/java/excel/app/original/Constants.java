...
public final class Constants {
	...
	public static class TAB3 {
		...
		public static String Company_Name_Required = "Company Name (Required)";
		public static String Address1_Required = "Address 1 (Required)";
		public static String Address2 = "Address 2";
		public static String Suburb_Required = "Suburb (Required)";
		public static String City = "City";
		public static String Post_Code_required = "Post Code (required)";
